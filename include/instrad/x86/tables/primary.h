...
namespace instrad::x86::tables
{
	...
	constexpr TableEntry ModRMExt_81[] = {
		/*0*/ entry_2(0x81, ops::ADD, OpKind::RegMemNative, OpKind::ImmNative),
		/*1*/ entry_2(0x81, ops::OR,  OpKind::RegMemNative, OpKind::ImmNative),
		/*2*/ entry_2(0x81, ops::ADC, OpKind::RegMemNative, OpKind::ImmNative),
		/*3*/ entry_2(0x81, ops::SBB, OpKind::RegMemNative, OpKind::ImmNative),
		/*4*/ entry_2(0x81, ops::AND, OpKind::RegMemNative, OpKind::ImmNative),
		/*5*/ entry_2(0x81, ops::SUB, OpKind::RegMemNative, OpKind::ImmNative),
		/*6*/ entry_2(0x81, ops::XOR, OpKind::RegMemNative, OpKind::ImmNative),
		/*7*/ entry_2(0x81, ops::CMP, OpKind::RegMemNative, OpKind::ImmNative),
	};
	...
	constexpr TableEntry ModRMExt_83[] = {
		/*0*/ entry_2(0x83, ops::ADD, OpKind::RegMemNative, OpKind::SignExtImm8),
		/*1*/ entry_2(0x83, ops::OR,  OpKind::RegMemNative, OpKind::SignExtImm8),
		/*2*/ entry_2(0x83, ops::ADC, OpKind::RegMemNative, OpKind::SignExtImm8),
		/*3*/ entry_2(0x83, ops::SBB, OpKind::RegMemNative, OpKind::SignExtImm8),
		/*4*/ entry_2(0x83, ops::AND, OpKind::RegMemNative, OpKind::SignExtImm8),
		/*5*/ entry_2(0x83, ops::SUB, OpKind::RegMemNative, OpKind::SignExtImm8),
		/*6*/ entry_2(0x83, ops::XOR, OpKind::RegMemNative, OpKind::SignExtImm8),
		/*7*/ entry_2(0x83, ops::CMP, OpKind::RegMemNative, OpKind::SignExtImm8),
	};
	...
	constexpr TableEntry ModRMExt_C1[] = {
		/*0*/ entry_2(0xC1, ops::ROL, OpKind::RegMemNative, OpKind::Imm8),
		/*1*/ entry_2(0xC1, ops::ROR, OpKind::RegMemNative, OpKind::Imm8),
		/*2*/ entry_2(0xC1, ops::RCL, OpKind::RegMemNative, OpKind::Imm8),
		/*3*/ entry_2(0xC1, ops::RCR, OpKind::RegMemNative, OpKind::Imm8),
		/*4*/ entry_2(0xC1, ops::SHL, OpKind::RegMemNative, OpKind::Imm8),
		/*5*/ entry_2(0xC1, ops::SHR, OpKind::RegMemNative, OpKind::Imm8),
		/*6*/ entry_2(0xC1, ops::SAL, OpKind::RegMemNative, OpKind::Imm8),
		/*7*/ entry_2(0xC1, ops::SAR, OpKind::RegMemNative, OpKind::Imm8),
	};
	...
	constexpr TableEntry ModRMExt_C7[] = {
		/*0*/ entry_2(0xC7, ops::MOV, OpKind::RegMemNative, OpKind::ImmNative),
	...
	constexpr TableEntry ModRMExt_D1[] = {
		/*0*/ entry_1(0xD1, ops::ROL, OpKind::RegMemNative),
		/*1*/ entry_1(0xD1, ops::ROR, OpKind::RegMemNative),
		/*2*/ entry_1(0xD1, ops::RCL, OpKind::RegMemNative),
		/*3*/ entry_1(0xD1, ops::RCR, OpKind::RegMemNative),
		/*4*/ entry_1(0xD1, ops::SHL, OpKind::RegMemNative),
		/*5*/ entry_1(0xD1, ops::SHR, OpKind::RegMemNative),
		/*6*/ entry_1(0xD1, ops::SAL, OpKind::RegMemNative),
		/*7*/ entry_1(0xD1, ops::SAR, OpKind::RegMemNative),
	};
	...
	constexpr TableEntry ModRMExt_D3[] = {
		/*0*/ entry_2(0xD3, ops::ROL, OpKind::RegMemNative, OpKind::ImplicitCL),
		/*1*/ entry_2(0xD3, ops::ROR, OpKind::RegMemNative, OpKind::ImplicitCL),
		/*2*/ entry_2(0xD3, ops::RCL, OpKind::RegMemNative, OpKind::ImplicitCL),
		/*3*/ entry_2(0xD3, ops::RCR, OpKind::RegMemNative, OpKind::ImplicitCL),
		/*4*/ entry_2(0xD3, ops::SHL, OpKind::RegMemNative, OpKind::ImplicitCL),
		/*5*/ entry_2(0xD3, ops::SHR, OpKind::RegMemNative, OpKind::ImplicitCL),
		/*6*/ entry_2(0xD3, ops::SAL, OpKind::RegMemNative, OpKind::ImplicitCL),
		/*7*/ entry_2(0xD3, ops::SAR, OpKind::RegMemNative, OpKind::ImplicitCL),
	};
	...
	constexpr TableEntry ModRMExt_F7[] = {
		/*0*/ entry_2(0xF7, ops::TEST, OpKind::RegMemNative, OpKind::ImmNative),
		/*1*/ entry_2(0xF7, ops::TEST, OpKind::RegMemNative, OpKind::ImmNative),
		/*2*/ entry_1(0xF7, ops::NOT,  OpKind::RegMemNative),
		/*3*/ entry_1(0xF7, ops::NEG,  OpKind::RegMemNative),
		/*4*/ entry_1(0xF7, ops::MUL,  OpKind::RegMemNative),
		/*5*/ entry_1(0xF7, ops::IMUL, OpKind::RegMemNative),
		/*6*/ entry_1(0xF7, ops::DIV,  OpKind::RegMemNative),
		/*7*/ entry_1(0xF7, ops::IDIV, OpKind::RegMemNative),
	};
	...
	constexpr TableEntry PrimaryOpcodeMap[] = {
		...
		/*01*/ entry_2(0x01, ops::ADD,  OpKind::RegMemNative, OpKind::RegNative),
		/*02*/ entry_2(0x02, ops::ADD,  OpKind::Reg8, OpKind::RegMem8),
		/*03*/ entry_2(0x03, ops::ADD,  OpKind::RegNative, OpKind::RegMemNative),
		/*04*/ entry_2_no_modrm(0x04, ops::ADD,  OpKind::ImplicitAL, OpKind::Imm8),
		/*05*/ entry_2_no_modrm(0x05, ops::ADD,  OpKind::ImplicitNativeAX, OpKind::ImmNative),
		...
		/*09*/ entry_2(0x09, ops::OR, OpKind::RegMemNative, OpKind::RegNative),
		/*0A*/ entry_2(0x0A, ops::OR, OpKind::Reg8, OpKind::RegMem8),
		/*0B*/ entry_2(0x0B, ops::OR, OpKind::RegNative, OpKind::RegMemNative),
		/*0C*/ entry_2_no_modrm(0x0C, ops::OR,   OpKind::ImplicitAL, OpKind::Imm8),
		/*0D*/ entry_2_no_modrm(0x0D, ops::OR,   OpKind::ImplicitNativeAX, OpKind::ImmNative),
		...
		/*11*/ entry_2(0x11, ops::ADC, OpKind::RegMemNative, OpKind::RegNative),
		/*12*/ entry_2(0x12, ops::ADC, OpKind::Reg8, OpKind::RegMem8),
		/*13*/ entry_2(0x13, ops::ADC, OpKind::RegNative, OpKind::RegMemNative),
		/*14*/ entry_2_no_modrm(0x14, ops::ADC,  OpKind::ImplicitAL, OpKind::Imm8),
		/*15*/ entry_2_no_modrm(0x15, ops::ADC,  OpKind::ImplicitNativeAX, OpKind::ImmNative),
		...
		/*19*/ entry_2(0x19, ops::SBB, OpKind::RegMemNative, OpKind::RegNative),
		/*1A*/ entry_2(0x1A, ops::SBB, OpKind::Reg8, OpKind::RegMem8),
		/*1B*/ entry_2(0x1B, ops::SBB, OpKind::RegNative, OpKind::RegMemNative),
		/*1C*/ entry_2_no_modrm(0x1C, ops::SBB,  OpKind::ImplicitAL, OpKind::Imm8),
		/*1D*/ entry_2_no_modrm(0x1D, ops::SBB,  OpKind::ImplicitNativeAX, OpKind::ImmNative),
		...
		/*21*/ entry_2(0x21, ops::AND, OpKind::RegMemNative, OpKind::RegNative),
		/*22*/ entry_2(0x22, ops::AND, OpKind::Reg8, OpKind::RegMem8),
		/*23*/ entry_2(0x23, ops::AND, OpKind::RegNative, OpKind::RegMemNative),
		/*24*/ entry_2_no_modrm(0x24, ops::AND, OpKind::ImplicitAL, OpKind::Imm8),
		/*25*/ entry_2_no_modrm(0x25, ops::AND, OpKind::ImplicitNativeAX, OpKind::ImmNative),
		...
		/*29*/ entry_2(0x29, ops::SUB, OpKind::RegMemNative, OpKind::RegNative),
		/*2A*/ entry_2(0x2A, ops::SUB, OpKind::Reg8, OpKind::RegMem8),
		/*2B*/ entry_2(0x2B, ops::SUB, OpKind::RegNative, OpKind::RegMemNative),
		/*2C*/ entry_2_no_modrm(0x2C, ops::SUB, OpKind::ImplicitAL, OpKind::Imm8),
		/*2D*/ entry_2_no_modrm(0x2D, ops::SUB, OpKind::ImplicitNativeAX, OpKind::ImmNative),
		...
		/*31*/ entry_2(0x31, ops::XOR, OpKind::RegMemNative, OpKind::RegNative),
		/*32*/ entry_2(0x32, ops::XOR, OpKind::Reg8, OpKind::RegMem8),
		/*33*/ entry_2(0x33, ops::XOR, OpKind::RegNative, OpKind::RegMemNative),
		/*34*/ entry_2_no_modrm(0x34, ops::XOR, OpKind::ImplicitAL, OpKind::Imm8),
		/*35*/ entry_2_no_modrm(0x35, ops::XOR, OpKind::ImplicitNativeAX, OpKind::ImmNative),
		...
		/*39*/ entry_2(0x39, ops::CMP, OpKind::RegMemNative, OpKind::RegNative),
		/*3A*/ entry_2(0x3A, ops::CMP, OpKind::Reg8, OpKind::RegMem8),
		/*3B*/ entry_2(0x3B, ops::CMP, OpKind::RegNative, OpKind::RegMemNative),
		/*3C*/ entry_2_no_modrm(0x3C, ops::CMP, OpKind::ImplicitAL, OpKind::Imm8),
		/*3D*/ entry_2_no_modrm(0x3D, ops::CMP, OpKind::ImplicitNativeAX, OpKind::ImmNative),
		...
		/*40*/ entry_lnri_1(0x40, ops::INC, OpKind::RegNative),
		/*41*/ entry_lnri_1(0x41, ops::INC, OpKind::RegNative),
		/*42*/ entry_lnri_1(0x42, ops::INC, OpKind::RegNative),
		/*43*/ entry_lnri_1(0x43, ops::INC, OpKind::RegNative),
		/*44*/ entry_lnri_1(0x44, ops::INC, OpKind::RegNative),
		/*45*/ entry_lnri_1(0x45, ops::INC, OpKind::RegNative),
		/*46*/ entry_lnri_1(0x46, ops::INC, OpKind::RegNative),
		/*47*/ entry_lnri_1(0x47, ops::INC, OpKind::RegNative),

		/*48*/ entry_lnri_1(0x48, ops::DEC, OpKind::RegNative),
		/*49*/ entry_lnri_1(0x49, ops::DEC, OpKind::RegNative),
		/*4A*/ entry_lnri_1(0x4A, ops::DEC, OpKind::RegNative),
		/*4B*/ entry_lnri_1(0x4B, ops::DEC, OpKind::RegNative),
		/*4C*/ entry_lnri_1(0x4C, ops::DEC, OpKind::RegNative),
		/*4D*/ entry_lnri_1(0x4D, ops::DEC, OpKind::RegNative),
		/*4E*/ entry_lnri_1(0x4E, ops::DEC, OpKind::RegNative),
		/*4F*/ entry_lnri_1(0x4F, ops::DEC, OpKind::RegNative),

		/*50*/ entry_lnri_1(0x50, ops::PUSH, OpKind::RegNative),
		/*51*/ entry_lnri_1(0x51, ops::PUSH, OpKind::RegNative),
		/*52*/ entry_lnri_1(0x52, ops::PUSH, OpKind::RegNative),
		/*53*/ entry_lnri_1(0x53, ops::PUSH, OpKind::RegNative),
		/*54*/ entry_lnri_1(0x54, ops::PUSH, OpKind::RegNative),
		/*55*/ entry_lnri_1(0x55, ops::PUSH, OpKind::RegNative),
		/*56*/ entry_lnri_1(0x56, ops::PUSH, OpKind::RegNative),
		/*57*/ entry_lnri_1(0x57, ops::PUSH, OpKind::RegNative),

		/*58*/ entry_lnri_1(0x58, ops::POP, OpKind::RegNative),
		/*59*/ entry_lnri_1(0x59, ops::POP, OpKind::RegNative),
		/*5A*/ entry_lnri_1(0x5A, ops::POP, OpKind::RegNative),
		/*5B*/ entry_lnri_1(0x5B, ops::POP, OpKind::RegNative),
		/*5C*/ entry_lnri_1(0x5C, ops::POP, OpKind::RegNative),
		/*5D*/ entry_lnri_1(0x5D, ops::POP, OpKind::RegNative),
		/*5E*/ entry_lnri_1(0x5E, ops::POP, OpKind::RegNative),
		/*5F*/ entry_lnri_1(0x5F, ops::POP, OpKind::RegNative),
		...
		/*69*/ entry_3(0x69, ops::IMUL, OpKind::RegNative, OpKind::RegMemNative, OpKind::ImmNative),
		/*6A*/ entry_1_no_modrm(0x6A, ops::PUSH, OpKind::Imm8),
		/*6B*/ entry_3(0x6B, ops::IMUL, OpKind::RegNative, OpKind::RegMemNative, OpKind::Imm8),
		/*6C*/ entry_2(0x6C, ops::INSB, OpKind::ImplicitMem8_ES_EDI, OpKind::ImplicitDX),
		/*6D*/ entry_2(0x6D, ops::INS, OpKind::ImplicitMemNative_ES_DI, OpKind::ImplicitDX),
		/*6E*/ entry_2(0x6E, ops::OUTSB, OpKind::ImplicitDX, OpKind::ImplicitMem8_ES_EDI),
		/*6F*/ entry_2(0x6F, ops::OUTS, OpKind::ImplicitDX, OpKind::ImplicitMemNative_ES_DI),
		...
		/*85*/ entry_2(0x85, ops::TEST, OpKind::RegMemNative,   OpKind::RegNative),
		/*86*/ entry_2(0x86, ops::XCHG, OpKind::RegMem8,        OpKind::Reg8),
		/*87*/ entry_2(0x87, ops::XCHG, OpKind::RegMemNative,   OpKind::RegNative),

		/*88*/ entry_2(0x88, ops::MOV, OpKind::RegMem8,         OpKind::Reg8),
		/*89*/ entry_2(0x89, ops::MOV, OpKind::RegMemNative,    OpKind::RegNative),
		/*8A*/ entry_2(0x8A, ops::MOV, OpKind::Reg8,            OpKind::RegMem8),
		/*8B*/ entry_2(0x8B, ops::MOV, OpKind::RegNative,       OpKind::RegMemNative),
		/*8C*/ entry_2(0x8C, ops::MOV, OpKind::RegMem16,        OpKind::SegmentReg),
		/*8D*/ entry_2(0x8D, ops::LEA, OpKind::RegNative,       OpKind::Memory),
		...
		/*90*/ entry_lnri_2(0x90, ops::XCHG, OpKind::ImplicitNativeAX, OpKind::RegNative),
		/*91*/ entry_lnri_2(0x91, ops::XCHG, OpKind::ImplicitNativeAX, OpKind::RegNative),
		/*92*/ entry_lnri_2(0x92, ops::XCHG, OpKind::ImplicitNativeAX, OpKind::RegNative),
		/*93*/ entry_lnri_2(0x93, ops::XCHG, OpKind::ImplicitNativeAX, OpKind::RegNative),
		/*94*/ entry_lnri_2(0x94, ops::XCHG, OpKind::ImplicitNativeAX, OpKind::RegNative),
		/*95*/ entry_lnri_2(0x95, ops::XCHG, OpKind::ImplicitNativeAX, OpKind::RegNative),
		/*96*/ entry_lnri_2(0x96, ops::XCHG, OpKind::ImplicitNativeAX, OpKind::RegNative),
		/*97*/ entry_lnri_2(0x97, ops::XCHG, OpKind::ImplicitNativeAX, OpKind::RegNative),
		...
		/*A1*/ entry_2_no_modrm(0xA1, ops::MOV, OpKind::ImplicitNativeAX,   OpKind::MemoryOfsNative),
		/*A2*/ entry_2_no_modrm(0xA2, ops::MOV, OpKind::MemoryOfs8,         OpKind::ImplicitAL),
		/*A3*/ entry_2_no_modrm(0xA3, ops::MOV, OpKind::MemoryOfsNative,    OpKind::ImplicitNativeAX),
		/*A4*/ entry_2_no_modrm(0xA4, ops::MOVSB, OpKind::ImplicitMem8_ES_EDI,      OpKind::ImplicitMem8_ESI),
		/*A5*/ entry_2_no_modrm(0xA5, ops::MOVS,  OpKind::ImplicitMemNative_ES_DI,  OpKind::ImplicitMemNative_SI),
		/*A6*/ entry_2_no_modrm(0xA6, ops::CMPSB, OpKind::ImplicitMem8_ES_EDI,      OpKind::ImplicitMem8_ESI),
		/*A7*/ entry_2_no_modrm(0xA7, ops::CMPS,  OpKind::ImplicitMemNative_ES_DI,  OpKind::ImplicitMemNative_SI),

		/*A8*/ entry_2_no_modrm(0xA8, ops::TEST, OpKind::ImplicitAL, OpKind::Imm8),
		/*A9*/ entry_2_no_modrm(0xA9, ops::TEST, OpKind::ImplicitAX, OpKind::Imm32),
		/*AA*/ entry_2_no_modrm(0xAA, ops::STOSB, OpKind::ImplicitMem8_ES_EDI, OpKind::ImplicitAL),
		/*AB*/ entry_2_no_modrm(0xAB, ops::STOS,  OpKind::ImplicitMemNative_ES_DI, OpKind::ImplicitAX),
		/*AC*/ entry_2_no_modrm(0xAC, ops::LODSB, OpKind::ImplicitAL, OpKind::ImplicitMem8_ESI),
		/*AD*/ entry_2_no_modrm(0xAD, ops::LODS,  OpKind::ImplicitAX, OpKind::ImplicitMemNative_SI),
		/*AE*/ entry_2_no_modrm(0xAE, ops::SCASB, OpKind::ImplicitAL, OpKind::ImplicitMem8_ESI),
		/*AF*/ entry_2_no_modrm(0xAF, ops::SCAS,  OpKind::ImplicitAX, OpKind::ImplicitMemNative_SI),
		...
		/*B8*/ entry_lnri_2(0xB8, ops::MOV, OpKind::RegNative, OpKind::Imm64),
		/*B9*/ entry_lnri_2(0xB9, ops::MOV, OpKind::RegNative, OpKind::Imm64),
		/*BA*/ entry_lnri_2(0xBA, ops::MOV, OpKind::RegNative, OpKind::Imm64),
		/*BB*/ entry_lnri_2(0xBB, ops::MOV, OpKind::RegNative, OpKind::Imm64),
		/*BC*/ entry_lnri_2(0xBC, ops::MOV, OpKind::RegNative, OpKind::Imm64),
		/*BD*/ entry_lnri_2(0xBD, ops::MOV, OpKind::RegNative, OpKind::Imm64),
		/*BE*/ entry_lnri_2(0xBE, ops::MOV, OpKind::RegNative, OpKind::Imm64),
		/*BF*/ entry_lnri_2(0xBF, ops::MOV, OpKind::RegNative, OpKind::Imm64),
